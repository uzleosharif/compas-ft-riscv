...
class RISCVDmr : public llvm::MachineFunctionPass {
 ...
 protected:
  ...
  struct DMRConfig {
    ...
    riscv_common::ErrorDetectionStrategy eds{riscv_common::ErrorDetectionStrategy::ED0};
  };
  ...
  const std::map<llvm::Register, std::string> Reg2Name_{
      ...
      {llvm::RISCV::X3, "gp"},        {llvm::RISCV::X4, "tp"},        {llvm::RISCV::X5, "t0"},
      {llvm::RISCV::X6, "t1"},        {llvm::RISCV::X7, "t2"},        {llvm::RISCV::X8, "s0"},
      {llvm::RISCV::X9, "s1"},        {llvm::RISCV::X10, "a0"},       {llvm::RISCV::X11, "a1"},
      {llvm::RISCV::X12, "a2"},       {llvm::RISCV::X13, "a3"},       {llvm::RISCV::X14, "a4"},
      {llvm::RISCV::X15, "a5"},       {llvm::RISCV::X16, "a6"},       {llvm::RISCV::X17, "a7"},
      {llvm::RISCV::X18, "s2"},       {llvm::RISCV::X19, "s3"},       {llvm::RISCV::X20, "s4"},
      {llvm::RISCV::X21, "s5"},       {llvm::RISCV::X22, "s6"},       {llvm::RISCV::X23, "s7"},
      {llvm::RISCV::X24, "s8"},       {llvm::RISCV::X25, "s9"},       {llvm::RISCV::X26, "s10"},
      {llvm::RISCV::X27, "s11"},      {llvm::RISCV::X28, "t3"},       {llvm::RISCV::X29, "t4"},
      {llvm::RISCV::X30, "t5"},       {llvm::RISCV::X31, "t6"},       {llvm::RISCV::F0_F, "ft0"},
      {llvm::RISCV::F1_F, "ft1"},     {llvm::RISCV::F2_F, "ft2"},     {llvm::RISCV::F3_F, "ft3"},
      {llvm::RISCV::F4_F, "ft4"},     {llvm::RISCV::F5_F, "ft5"},     {llvm::RISCV::F6_F, "ft6"},
      {llvm::RISCV::F7_F, "ft7"},     {llvm::RISCV::F8_F, "fs0"},     {llvm::RISCV::F9_F, "fs1"},
      {llvm::RISCV::F10_F, "fa0"},    {llvm::RISCV::F11_F, "fa1"},    {llvm::RISCV::F12_F, "fa2"},
      {llvm::RISCV::F13_F, "fa3"},    {llvm::RISCV::F14_F, "fa4"},    {llvm::RISCV::F15_F, "fa5"},
      {llvm::RISCV::F16_F, "fa6"},    {llvm::RISCV::F17_F, "fa7"},    {llvm::RISCV::F18_F, "fs2"},
      {llvm::RISCV::F19_F, "fs3"},    {llvm::RISCV::F20_F, "fs4"},    {llvm::RISCV::F21_F, "fs5"},
      {llvm::RISCV::F22_F, "fs6"},    {llvm::RISCV::F23_F, "fs7"},    {llvm::RISCV::F24_F, "fs8"},
      {llvm::RISCV::F25_F, "fs9"},    {llvm::RISCV::F26_F, "fs10"},   {llvm::RISCV::F27_F, "fs11"},
      {llvm::RISCV::F28_F, "ft8"},    {llvm::RISCV::F29_F, "ft9"},    {llvm::RISCV::F30_F, "ft10"},
      {llvm::RISCV::F31_F, "ft11"},   {llvm::RISCV::F0_D, "ft0_d"},   {llvm::RISCV::F1_D, "ft1_d"},
      {llvm::RISCV::F2_D, "ft2_d"},   {llvm::RISCV::F3_D, "ft3_d"},   {llvm::RISCV::F4_D, "ft4_d"},
      {llvm::RISCV::F5_D, "ft5_d"},   {llvm::RISCV::F6_D, "ft6_d"},   {llvm::RISCV::F7_D, "ft7_d"},
      {llvm::RISCV::F8_D, "fs0_d"},   {llvm::RISCV::F9_D, "fs1_d"},   {llvm::RISCV::F10_D, "fa0_d"},
      {llvm::RISCV::F11_D, "fa1_d"},  {llvm::RISCV::F12_D, "fa2_d"},  {llvm::RISCV::F13_D, "fa3_d"},
      {llvm::RISCV::F14_D, "fa4_d"},  {llvm::RISCV::F15_D, "fa5_d"},  {llvm::RISCV::F16_D, "fa6_d"},
      {llvm::RISCV::F17_D, "fa7_d"},  {llvm::RISCV::F18_D, "fs2_d"},  {llvm::RISCV::F19_D, "fs3_d"},
      {llvm::RISCV::F20_D, "fs4_d"},  {llvm::RISCV::F21_D, "fs5_d"},  {llvm::RISCV::F22_D, "fs6_d"},
      {llvm::RISCV::F23_D, "fs7_d"},  {llvm::RISCV::F24_D, "fs8_d"},  {llvm::RISCV::F25_D, "fs9_d"},
      {llvm::RISCV::F26_D, "fs10_d"}, {llvm::RISCV::F27_D, "fs11_d"}, {llvm::RISCV::F28_D, "ft8_d"},
      {llvm::RISCV::F29_D, "ft9_d"},  {llvm::RISCV::F30_D, "ft10_d"}, {llvm::RISCV::F31_D, "ft11_d"}};
  ...
  const std::map<std::string, bool> knownLibcalls2Duplicable_{
      {"printf", false},     {"strlen", true},        {"srand", false},        {"rand", false},
      {"cos", true},         {"sin", true},           {"puts", false},         {"putchar", false},
      {"exit", false},       {"__extendsfdf2", true}, {"__truncdfsf2", true},  {"__floatunsidf", true},
      {"__divdf3", true},    {"__muldf3", true},      {"__adddf3", true},      {"__subdf3", true},
      {"__modsi3", true},    {"__floatsisf", true},   {"__floatunsisf", true}, {"__mulsf3", true},
      {"strncmp", true},     {"__mulsi3", true},      {"memset", true},        {"memcpy", true},
      {"memcmp", true},      {"atan", true},          {"__extenddftf2", true}, {"__multf3", true},
      {"__addtf3", true},    {"__divtf3", true},      {"__subtf3", true},      {"__trunctfdf2", true},
      {"pow", true},         {"__lttf2", true},       {"acos", true},          {"sqrt", true},
      {"__floatsidf", true}, {"__ltdf2", true},       {"__ledf2", true},       {"__gtdf2", true},
      {"__nedf2", true},     {"__udivsi3", true}};
  // TODO: static constexpr??
  const std::map<unsigned, unsigned> LBStore2Load_{
      {llvm::RISCV::SW, llvm::RISCV::LW},   {llvm::RISCV::SD, llvm::RISCV::LD},   {llvm::RISCV::SH, llvm::RISCV::LHU},
      {llvm::RISCV::SB, llvm::RISCV::LBU},  {llvm::RISCV::SC_W, llvm::RISCV::LW}, {llvm::RISCV::SC_D, llvm::RISCV::LD},
      {llvm::RISCV::FSW, llvm::RISCV::FLW}, {llvm::RISCV::FSD, llvm::RISCV::FLD}};
  // TODO: static constexpr??
  const std::set<llvm::Register> callee_saved_regs_{
      llvm::RISCV::X8,    llvm::RISCV::X9,    llvm::RISCV::X18,   llvm::RISCV::X19,   llvm::RISCV::X20,
      llvm::RISCV::X21,   llvm::RISCV::X22,   llvm::RISCV::X23,   llvm::RISCV::X24,   llvm::RISCV::X25,
      llvm::RISCV::X26,   llvm::RISCV::X27,   llvm::RISCV::F8_F,  llvm::RISCV::F9_F,  llvm::RISCV::F18_F,
      llvm::RISCV::F19_F, llvm::RISCV::F20_F, llvm::RISCV::F21_F, llvm::RISCV::F22_F, llvm::RISCV::F23_F,
      llvm::RISCV::F24_F, llvm::RISCV::F25_F, llvm::RISCV::F26_F, llvm::RISCV::F27_F, llvm::RISCV::F8_D,
      llvm::RISCV::F9_D,  llvm::RISCV::F18_D, llvm::RISCV::F19_D, llvm::RISCV::F20_D, llvm::RISCV::F21_D,
      llvm::RISCV::F22_D, llvm::RISCV::F23_D, llvm::RISCV::F24_D, llvm::RISCV::F25_D, llvm::RISCV::F26_D,
      llvm::RISCV::F27_D, llvm::RISCV::F8_H,  llvm::RISCV::F9_H,  llvm::RISCV::F18_H, llvm::RISCV::F19_H,
      llvm::RISCV::F20_H, llvm::RISCV::F21_H, llvm::RISCV::F22_H, llvm::RISCV::F23_H, llvm::RISCV::F24_H,
  ...
  void moveIntoShadow(llvm::MachineBasicBlock*, llvm::MachineBasicBlock::iterator, llvm::Register, llvm::Register);
  void syncFPRegs(llvm::MachineBasicBlock*, llvm::MachineBasicBlock::iterator, llvm::Register, llvm::Register);
};
